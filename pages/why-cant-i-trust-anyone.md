...
The hardest version of the inversion is the one people are most ashamed of. Trust sometimes extends faster to people who are bad for you than to people who are safe. A familiar dynamic, even a painful one, reads as predictable, and this pattern optimises for predictability over safety, because predictability was the thing that was missing. An unfamiliar kindness offers no such guarantee. [Why the same kind of person keeps reappearing is worth settling separately.](/insights/why-do-i-attract-the-same-people/)
...
Expect a step pattern rather than a slope: long flat stretches, occasional sudden jumps, and a bad fortnight after any ending, any betrayal in the news, or any piece of information that rhymes with the original one. A setback of that kind is the system doing what it learned rather than proof that none of the work took.
